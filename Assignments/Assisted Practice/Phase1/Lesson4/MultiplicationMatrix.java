...
public class MultiplicationMatrix {
		...
		public static void main(String[] args) {
			...
			int [][] firstMatrix= {{1,-2,3},{5,9,10}};
			int [][] secondMatrix= {{8,4},{-5,5},{4,3}};
			
			
			int[][]  product= multiplyMatrix(firstMatrix,secondMatrix,r1,c1,c2);   //method to multiply the matrix
			
			
			displayProduct(product);                                     //display the result of multiplication}
		}
